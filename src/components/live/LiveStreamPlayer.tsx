    ...
    >
      ...
      {currentContent && (
        <a
          ...
          className="absolute top-4 left-4 flex items-center gap-2 bg-black/50 hover:bg-black/70 px-3 py-2 rounded-lg text-white z-10 transition-colors"
        ...
        >
          ...
          <span className="text-sm font-medium capitalize">
            {currentContent.source_platform || 'Source'}
          </span>
        </a>
      )}
